function [sphAngOut] = rotEulersph(sphAngIn,angEuler)

% [sphAngOut] = rotEulersph(sphAngIn,angEuler)
% rotates the spherical angles, specified in sphAngIn [ph;th] (rad) (can have
% multiple columns), by the Euler angles in angEuler [th,ph,ps].
