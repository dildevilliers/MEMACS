...
% Created: 2026-03-04, Dirk de Villiers, Stellenbosch
% Updated: 2026-03-04, Dirk de Villiers, Stellenbosch
...
try
    v1 = Vect3D([0 0;0 0;1 2],[0 1; 0 1; 0 1]);
    v2 = Vect3D([0 0;0 0;1 2],Pnt3D);    
    v3 = Vect3D([0;0;1],[0 1; 0 1; 0 1]);
...
c1 = c1.rotGRASP(deg2rad([45,45,0]));
v3_ = v3.changeBase(c0,c1);

pEnd = v3.pEnd.changeBase(c0,c1);

if all(abs(v3_.pEnd.pointMatrix - pEnd.pointMatrix) < 1e-15)
